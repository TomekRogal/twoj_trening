        ...
        <div class="col-lg-5">
          <div class="card shadow-lg border-0 rounded-lg mt-5">
            <form:form method="post"
              ...
              Ćwiczenie: <form:select cssClass="form-control" itemLabel="name" itemValue="id" path="exercise" items="${exercises}"/><br>
              <form:errors  path="training"/><br>
              Serie: <form:input cssClass="form-control" type="number" path="sets"/> <br>
              <form:errors path="sets"/><br>
              Powtórzenia: <form:input cssClass="form-control" type="number" path="reps"/> <br>
              <form:errors path="reps"/><br>
              Ciężar: <form:input cssClass="form-control" type="number" step="0.01" path="weight"/> <br>
