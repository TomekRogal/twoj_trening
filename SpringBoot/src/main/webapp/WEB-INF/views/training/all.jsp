    ...
    <div id="layoutSidenav_content">
        <div class="card mb-4">
            <div class="ms-auto px-2 mt-5" >
                    <a href="/training/add" ><button type="button" class="btn btn-primary ">Dodaj trening</button></a>
            </div>
                    ...
                    <c:forEach items="${trainings}" var="training">
                        <tr>
                            ...
                            <td>
                                    ...
                                    <a href="/training/show/${training.id}" ><button type="button" class="btn btn-success">Szczegóły</button></a>
                                    <a href="/training/delete/${training.id}" class="delete-link"><button type="button" class="btn btn-danger">Usuń</button></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
